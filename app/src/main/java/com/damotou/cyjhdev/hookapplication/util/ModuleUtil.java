...
import com.damotou.cyjhdev.hookapplication.InstallerFragment;
...
public final class ModuleUtil {
    ...
    private static final String MODULES_LIST_FILE = XhookApp.BASE_DIR + "conf/modules.list";

    private ModuleUtil() {
        mApp = XhookApp.getInstance();
...
//
    ...
    public synchronized void updateModulesList(boolean showToast) {
        try {
            Log.i(XhookApp.TAG, "updating modules.list");
            ...
            Log.e(XhookApp.TAG, "cannot write " + MODULES_LIST_FILE, e);
