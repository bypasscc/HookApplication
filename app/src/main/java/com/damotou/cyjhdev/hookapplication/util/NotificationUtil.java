...
import com.damotou.cyjhdev.hookapplication.XHookInstallerActivity;
...
//        Intent iModulesTab = new Intent(sContext, XHookInstallerActivity.class);
//        iModulesTab.putExtra(XHookInstallerActivity.EXTRA_SECTION, XHookInstallerActivity.TAB_MODULES);
...
//        sNotificationManager.notify(packageName, NOTIFICATION_MODULE_NOT_ACTIVATED_YET, builder.build());
    ...
    public static void showModulesUpdatedNotification() {
        Intent iInstallTab = new Intent(sContext, XHookInstallerActivity.class);
        iInstallTab.putExtra(XHookInstallerActivity.EXTRA_SECTION, XHookInstallerActivity.TAB_INSTALL);
...
//                Log.e(XhookApp.TAG, "Could not start root shell");
//                return;
//            }
//
...
//
//            if (returnCode != 0) {
//                Log.e(XhookApp.TAG, "Could not reboot:");
//                for (String line : messages) {
//                    Log.e(XhookApp.TAG, line);
//                }
//            }
//
//            rootUtil.dispose();
